...
const QUERY_TOPIC_RULES = [
  {
    ...
    aliases: [
      ...
      "แก้ไขข้อบังคับ",
      "การแก้ไขข้อบังคับ",
      "แก้ไขข้อบังคับบางข้อ",
      "การแก้ไขข้อบังคับบางข้อ",
      "ข้อบังคับสหกรณ์",
    ],
    conflicts: [
  ...
  },
  {
    ...
    conflicts: ["เลิกสหกรณ์", "สั่งเลิกสหกรณ์", "ชำระบัญชี", "ผู้ชำระบัญชี", "ถอนชื่อออกจากทะเบียน"],
    contextSignals: [
      "ผู้เริ่มก่อการ",
      "สมาชิกผู้ก่อการ",
      "ผู้ซึ่งประสงค์จะเป็นสมาชิก",
