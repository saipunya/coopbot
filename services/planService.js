  ...
  switch (config.detailLevel) {
    case "brief":
      return {
        ...
        summaryLineLimit: Number(config.summaryLineLimit || 4),
        explainSummaryLineLimit: Number(config.explainSummaryLineLimit || 6),
        detailLineLimit: Number(config.detailLineLimit || 4),
        ...
        conciseAiMaxOutputTokens: Number(config.conciseAiMaxOutputTokens || config.aiMaxOutputTokens || 180),
        ...
        followUpPrompt: String(config.followUpPrompt || "").trim(),
    ...
    case "deep":
      return {
        ...
        summaryLineLimit: Number(config.summaryLineLimit || 4),
        explainSummaryLineLimit: Number(config.explainSummaryLineLimit || 6),
        detailLineLimit: Number(config.detailLineLimit || 5),
        ...
        conciseAiMaxOutputTokens: Number(config.conciseAiMaxOutputTokens || 220),
    ...
    case "detailed":
      return {
        ...
        conciseAiMaxOutputTokens: Number(config.conciseAiMaxOutputTokens || 180),
    ...
    default:
      return {
        ...
        conciseAiMaxOutputTokens: Number(config.conciseAiMaxOutputTokens || 0),
