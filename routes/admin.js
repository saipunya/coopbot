...
router.post("/vinichai", requireAdminAuth, adminController.submitVinichai);
router.post("/vinichai/update", requireAdminAuth, adminController.updateVinichai);
router.post("/vinichai/delete", requireAdminAuth, adminController.deleteVinichai);
